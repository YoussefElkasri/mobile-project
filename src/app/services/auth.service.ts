...
import { Auth , createUserWithEmailAndPassword, signInWithEmailAndPassword, getAuth, authState, UserCredential, GoogleAuthProvider, signInWithCredential, sendEmailVerification, FacebookAuthProvider, GithubAuthProvider } from "@angular/fire/auth";
